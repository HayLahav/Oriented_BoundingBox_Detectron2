...
from detectron2.data import MetadataCatalog, DatasetCatalog, detection_utils as utils, transforms as T, build_detection_train_loader
...
@click.option('--num-gpus', default=1, help='Number of GPUs to use, default none')
def main(**flags):
    launch(
        train_detectron,
        flags["num_gpus"],
